...
class DriverRegistration extends StatefulWidget {
  ...
  DriverRegistration(this.index,
      {this.selfiePath, this.idPath, this.licensePath});
              ...
              DottedBorder(
                ...
                child: Container(
                  ...
                  child: widget.selfiePath == null
                          ...
                          children: <Widget>[
                            ...
                            RaisedButton(
                              onPressed: () async{
                                ...
                                widget.selfiePath = await Navigator.push(context,
                                 MaterialPageRoute(builder: (context) => CamerScreen(0,true)),
                                );
                              },
                              color: Colors.white,
                      ...
                      : Image.file(File(widget.selfiePath)),
                ),
              )
            ],
          )),
            ...
            children: <Widget>[
              ...
              DottedBorder(
                ...
                child: Container(
                    ...
                    width: 320,
                    // color: Colors.amber,
                   child: widget.idPath == null?  Column(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: <Widget>[
                        SizedBox(height: 0),
                        Container(
                        ...
                        RaisedButton(
                          onPressed: () async {
                            ...
                            widget.idPath = await Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=> CamerScreen(1, false)));
                          },
                          color: Colors.white,
                          shape: RoundedRectangleBorder(
                            side: BorderSide(
                          ...
                          child: Container(
                            constraints:
                                BoxConstraints(maxWidth: 90, minHeight: 0.0),
                            alignment: Alignment.center,
                            child: Text(
                              'Snap',
                              textAlign: TextAlign.center,
            ...
            children: <Widget>[
              ...
              DottedBorder(
                ...
                child: Container(
                    ...
                    width: 320,
                    // color: Colors.amber,
                    child: widget.licensePath == null?Column(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: <Widget>[
                        SizedBox(height: 0),
                        Container(
                        ...
                        RaisedButton(
                          onPressed: () async{
                            ...
                            //             new CamerScreen(2,false)));
                                   ...
                                   widget.licensePath = await Navigator.push(context,
                                 MaterialPageRoute(builder: (context) => CamerScreen(2,false)),
                                );
                          },
                          color: Colors.white,
                          shape: RoundedRectangleBorder(
                    ...
                    ) : Image.file(File(widget.licensePath)),
                    ),
              )
            ],
          )),
